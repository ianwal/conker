...
// TODO: Hmm.. this appears somewhat different than libultra
// https://decomp.me/scratch/SWYc2
#pragma GLOBAL_ASM("asm/nonmatchings/libultra/io/viswapcontext/__osViSwapContext.s")
