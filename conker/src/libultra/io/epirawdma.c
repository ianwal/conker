...
#pragma GLOBAL_ASM("asm/nonmatchings/libultra/io/epirawdma/__osEPiRawStartDma.s")

// TODO: Matches, but needs __osCurrentHandle to be defined, which is defined in pimgr.c
//       but the .data needs to be migrated for that file. 
#if 0
